using Grpc.Core;
using gRPC_dotNET7;
using gRPC_dotNET7.Protos;

namespace gRPC_dotNET7.Services
{
    public class SalesDataServices : SalesService.SalesServiceBase
    {
            ...
            IServerStreamWriter<SalesDataModel> responseStream, ServerCallContext context)
        {
            ...
            using (var reader = new StreamReader(Path.Combine("Data", "sales_records.csv")))
            {
